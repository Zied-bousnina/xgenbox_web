...
dispatch({
  ...
  axios.post(`${process.env.API_URL}/api/site/AddContactUs`,data )
  .then(res => {
      console.log(res)
      dispatch({
        type: SET_ERRORS,
...
export const FetchAllContact = (data)=>dispatch=>{
  axios.get(`${process.env.API_URL}/api/site/contactUs/fetchAll`,data )
  .then(res => {
      console.log(res)
...
export const GetContactUsById = (id,navigation)=>dispatch=>{
  ...
  axios.get(`${process.env.API_URL}/api/site/contactUs/fetchByID/${id}`)
  .then(res => {
      // console.log(res)
      dispatch({
...
dispatch({
  ...
  axios.put(`${process.env.API_URL}/api/site/contactUs/readed/${id}`)
  .then(res => {
    dispatch({
      type: SET_ERRORS,
      payload: []
