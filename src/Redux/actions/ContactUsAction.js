...
dispatch({
  ...
  axios.post(`https://xgenboxv2.onrender.com/api/site/AddContactUs`,data )
  .then(res => {
      console.log(res)
      dispatch({
        type: SET_ERRORS,
...
export const FetchAllContact = (data)=>dispatch=>{
  axios.get(`https://xgenboxv2.onrender.com/api/site/contactUs/fetchAll`,data )
  .then(res => {
      console.log(res)
...
export const GetContactUsById = (id,navigation)=>dispatch=>{
  ...
  axios.get(`https://xgenboxv2.onrender.com/api/site/contactUs/fetchByID/${id}`)
  .then(res => {
      // console.log(res)
      dispatch({
...
dispatch({
  ...
  axios.put(`https://xgenboxv2.onrender.com/api/site/contactUs/readed/${id}`)
  .then(res => {
    dispatch({
      type: SET_ERRORS,
      payload: []
