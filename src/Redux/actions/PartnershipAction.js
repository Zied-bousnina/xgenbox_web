...
dispatch({
  ...
  axios.post(`https://xgenbox.azurewebsites.net/api/site/Addpartnership`,data )
  .then(res => {
      console.log(res)
      dispatch({
        type: SET_ERRORS,
...
export const FetchAllPartnership = (data)=>dispatch=>{
  axios.get(`https://xgenbox.azurewebsites.net/api/site/partnerShip/fetchAll`,data )
  .then(res => {
      console.log(res)
...
export const GetPartnerDetailsById = (id,navigation)=>dispatch=>{
  ...
  axios.get(`https://xgenbox.azurewebsites.net/api/site/partnerShip/fetchByID/${id}`)
  .then(res => {
      // console.log(res)
      dispatch({
...
dispatch({
  ...
  axios.put(`https://xgenbox.azurewebsites.net/api/site/partnerShip/readed/${id}`)
  .then(res => {
    dispatch({
      type: SET_ERRORS,
      payload: []
