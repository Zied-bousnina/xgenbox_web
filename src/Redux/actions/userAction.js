...
export const GetAllUsers = (navigation)=>dispatch=>{
  ...
  axios.get(`${process.env.API_URL}/api/users/getUsers`)
  .then(res => {
      // console.log(res)
      dispatch({
          type: SET_USERS,
...
export const GetAllUserDetails = (id,navigation)=>dispatch=>{
    ...
    axios.get(`${process.env.API_URL}/api/users/${id}`)
    .then(res => {
        // console.log(res)
        dispatch({
  ...
  export const BlockUser = (id,navigation)=>dispatch=>{
    ...
    axios.put(`${process.env.API_URL}/api/users/block/${id}`)
    .then(res => {
        // console.log(res)
  ...
  export const UnBlockUser = (id,navigation)=>dispatch=>{
    ...
    axios.put(`${process.env.API_URL}/api/users/deblock/${id}`)
    .then(res => {
        console.log(res)
