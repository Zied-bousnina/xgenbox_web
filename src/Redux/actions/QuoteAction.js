...
dispatch({
  ...
  axios.post(`https://xgenbox.azurewebsites.net/api/site/createQuote`,data, {   
...
export const FetchAllQuote = (data)=>dispatch=>{
  axios.get(`https://xgenbox.azurewebsites.net/api/site/quote/fetchAll`,data )
  .then(res => {
      // console.log(res)
...
export const GetQuoteById = (id,navigation)=>dispatch=>{
  ...
  axios.get(`https://xgenbox.azurewebsites.net/api/site/quote/fetchByID/${id}`)
  .then(res => {
      // console.log(res)
      dispatch({
...
dispatch({
  ...
  axios.put(`https://xgenbox.azurewebsites.net/api/site/Quote/readed/${id}`)
  .then(res => {
    dispatch({
      type: SET_ERRORS,
      payload: []
